...
//           console.log("change triggad");
             $.getJSON(urlen, function(data){
                    ...
                    switch(gruppvarde){
                        case 0: $('.undergrupp').append('<option value="">Ras/art</option>');
                        break;        
                        case 1: $('.undergrupp').append('<option value="">Välj hundras</option>');
                        ...
                        break;
                        case 2: $('.undergrupp').append('<option value="">Välj kattras</option>');
                        ...
                        break;
                        case 3: $('.undergrupp').append('<option value="">Välj fågelart</option>');
                        ...
                        break;
                        case 4: $('.undergrupp').append('<option value="">Välj Dinosaurie</option>');
